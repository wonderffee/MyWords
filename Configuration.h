...
#define BUTTON_INSTRUCTION_LABEL_FRAME						CGRectMake(14.0,12.0,200.0,24.0)

// Font of text in button to open dropdownlist
#define BUTTON_LABEL_FONT									[UIFont fontWithName:@"HelveticaNeue-Bold" size:14.0]
...
#define TITLE_LABEL_FONT									[UIFont fontWithName:@"HelveticaNeue-Bold" size:11.0]
...
#define DESCRIPTION_LABEL_FONT								[UIFont fontWithName:@"HelveticaNeue-Bold" size:10.00]

// Frame for title in dropdownlist item / button
#define ITEM_TITLE_LABEL_FRAME								CGRectMake(46.0,10.0,180.0,18.0)
#define BUTTON_TITLE_LABEL_FRAME							CGRectMake(50.0,13.0,180.0,16.0)
